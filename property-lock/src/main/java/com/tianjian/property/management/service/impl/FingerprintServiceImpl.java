...
public class FingerprintServiceImpl implements FingerprintService {
    ...
    public LockResult addFingerprint(Fingerprint fingerprint) {
        ...
        List<Fingerprint> list= fingerprintDao.selectByuser(doorId,addPerson);
        if (list.size()>=2){
    ...
    @Override
    public List<Fingerprint> selectFingerprint(Integer doorId,Integer appUID) {
        List<Fingerprint> list= fingerprintDao.selectByuser(doorId,appUID);
        return list;
    }
}
