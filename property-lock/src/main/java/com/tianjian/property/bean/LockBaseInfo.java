...
public class LockBaseInfo implements Serializable {
     ...
     * 获取联网模块的MAC   带433模块必填
     *
     * @return rfmodule_mac - 联网模块的MAC   带433模块必填
     */
     ...
     * 设置联网模块的MAC   带433模块必填
     *
     * @param rfmoduleMac 联网模块的MAC   带433模块必填
     */
    public void setRfmoduleMac(String rfmoduleMac) {
        this.rfmoduleMac = rfmoduleMac == null ? null : rfmoduleMac.trim();
    }
